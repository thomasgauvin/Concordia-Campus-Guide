    ...
    public void infoCardHallTest() {
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.info_card_title), withText("Henry F. Hall Building"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView2.check(matches(withText("Henry F. Hall Building")));
        ...
        ViewInteraction textView3 = onView(
                allOf(withId(R.id.building_address), withText("1455 De Maisonneuve West"),
                        isDisplayed()));
        textView3.check(matches(withText("1455 De Maisonneuve West")));
        ...
        ViewInteraction textView4 = onView(
                allOf(withId(R.id.departments_title), withText("Departments"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView4.check(matches(withText("Departments")));
        ...
        ViewInteraction textView7 = onView(
                allOf(withId(R.id.departments_list), withText("Geography,  Planning and Environment, Political Science,  Socialogy and Anthropology,  Economics, School of Irish Studies"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textView7.check(matches(withText("Geography,  Planning and Environment, Political Science,  Socialogy and Anthropology,  Economics, School of Irish Studies")));
